  ...
  Future<void> checkAndTransfer(
    ...
    if (adapterState != BluetoothAdapterState.on) {
      try {
        ...
        ToastUtils().showErrorToast('Bluetooth enable failed: $e');
    ...
    if (jsonData != null) {
      ...
      data = await generateData(text, flash, marq, isInverted, speedMap[speed],
          mode, jsonData, badgeHeight, badgeWidth);
    }
